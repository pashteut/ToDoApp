...
class UIMessagesStorage @Inject constructor(
    ...
    sealed class UIMessage {
        object SaveError : UIMessage()
        object DeleteError : UIMessage()
        object UpdateError : UIMessage()
        object LoadError : UIMessage()
        object AuthorizationError : UIMessage()
        object AuthorizationSuccess : UIMessage()
        object AuthorizationReset : UIMessage()
    }
}
