...
/**
 * Represents a single ToDo item for network requests and responses.
 *
 ...
 * @property importance The priority level of the ToDo item, represented by the [PriorityDTO] enum.
